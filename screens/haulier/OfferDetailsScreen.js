...
import { styles } from '../../styles/screens/OfferDetailsScreenStyles';
      ...
      <View style={styles.content}>
        ...
        {offer.status === 'pending' && (
          <View style={styles.actions}>
            ...
            >
              <Text style={styles.buttonSecondaryText}>Contact Forwarder</Text>
            </TouchableOpacity>
            
            <View style={styles.decisionActions}>
              <TouchableOpacity
                style={[styles.errorButton, styles.decisionButton]}
        ...
        {offer.status === 'accepted' && (
          <View style={styles.actions}>
            ...
            <TouchableOpacity
              ...
              onPress={handleContactForwarder}
            >
              <Text style={styles.buttonPrimaryText}>Contact Forwarder</Text>
            </TouchableOpacity>
          </View>
        )}
